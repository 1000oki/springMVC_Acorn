...
public class TestController {
	...
	@Autowired // spring bean container에 RemoconService type 객체가 있으면 자동 주입됨.(DI)
	...
	public String diUp() {
		 ...
		 *  DI 되어서 필드에 참조값이 있으므로 단순히 사용만 하면 됨.
		 *  
		 */
		service.up();
	...
	public String test() {
		...
		// /WEB-INF/views/move/test.jsp 페이지로 forward이동
		return "move/test";
	}
	...
	public String update() {
		...
		// "redirect: 리다이렉트 이동할 절대경로(context path는 쓰지 않음)"
	...
	public ModelAndView fortune3() {
		// view page의 정보를 객체를 생성할 때 바로 전달할 수 있다.
